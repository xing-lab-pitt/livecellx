...
custom_imports = dict(imports=["centroid_aug"], allow_failed_imports=False)
ver = "14-inclusive"
# frame_type = "all"
frame_type = "combined"
# frame_type = "video"
...
work_dir = f"./work_dirs/timesformer-default-divst-v{ver}-{frame_type}-random-crop-MC"
...
train_pipeline = [
    ...
    dict(type="RandomMaskCentroid", lb=2, ub=50),
