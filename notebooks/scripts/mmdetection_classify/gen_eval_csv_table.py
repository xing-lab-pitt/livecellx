...
test_results_dir_path = "./work_dirs/eval_results/"
results_csv_path = "./tmp_eval-results-all.csv"
...
for subfolder in subfolders:
    ...
    if os.path.exists(os.path.join(subfolder_path, "all_predictions.csv")) == False:
        print("Skipping", subfolder, ", as all_predictions.csv does not exist in the subfolder:", subfolder_path)
        continue
