...
model="v10_drop_div_clip=1_clipnum=1-combined"
$PYTHON train.py "configs/config_train_v10_div_cliplen=1_clipnum=1.py" --resume auto > $OUT_DIR/train_out_model"$model".out