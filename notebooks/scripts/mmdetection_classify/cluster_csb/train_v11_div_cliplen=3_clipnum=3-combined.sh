...
model="v11_drop_div_clip=3_clipnum=3-combined"
$PYTHON train.py "configs/config_train_v11_div_cliplen=3_clipnum=3-combined.py" --resume auto > $OUT_DIR/train_out_model"$model".out