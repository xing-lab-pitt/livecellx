...
model="v10_drop_div_clip=3_clipnum=3-video"
$PYTHON train.py "configs/config_train_v10_div_cliplen=3_clipnum=3-video.py" --resume auto > $OUT_DIR/train_out_model"$model".out