...
model="v10_st_cliplen=1_clipnum=3-video"
$PYTHON train.py "configs/config_train_v10_st_cliplen=1_clipnum=3-video.py" --resume auto > $OUT_DIR/train_out_model"$model".out