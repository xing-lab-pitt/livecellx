...
# modify model and params
model="v10_st_clip=1_clipnum=3-combined"
$PYTHON train.py "configs/config_train_v10_st_cliplen=1_clipnum=3-combined.py" --resume auto > $OUT_DIR/train_out_model"$model".out