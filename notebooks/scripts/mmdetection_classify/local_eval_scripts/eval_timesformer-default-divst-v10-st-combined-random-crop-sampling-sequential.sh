...
model="timesformer-default-divst-v10-st-combined-random-crop-sampling-sequential"
...
python classify_mmdetection_mitosis_eval.py \
    ...
    --config=$model_dir/"config_train_timesformer_divst_v10-corrected-combined-random-crop-sampling-sequantial.py" \
    --checkpoint=$model_dir/"best_acc_top1_epoch_162.pth" \
    --video_dir=$video_dir \
