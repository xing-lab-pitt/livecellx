...
model="tsn_imagenet-pretrained-r50_8xb32-1x1x3-100e_kinetics400-rgb-v13-drop-div-video-clipLen=2-trainClipNum=3-valClipNum=3"
...
python classify_mmdetection_mitosis_eval.py \
    ...
    --config=$model_dir/"config_train_v13_div_cliplen=2_clipnum=3-video.py" \
    --checkpoint=$model_dir/"best_acc_top1_epoch_11.pth" \
    --video_dir=$video_dir \
