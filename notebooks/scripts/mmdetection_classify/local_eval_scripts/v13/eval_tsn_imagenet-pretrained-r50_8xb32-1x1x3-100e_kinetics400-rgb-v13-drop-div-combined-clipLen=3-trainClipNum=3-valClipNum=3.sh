...
model="tsn_imagenet-pretrained-r50_8xb32-1x1x3-100e_kinetics400-rgb-v13-drop-div-combined-clipLen=3-trainClipNum=3-valClipNum=3"
...
python classify_mmdetection_mitosis_eval.py \
    ...
    --config=$model_dir/"config_train_v13_div_cliplen=3_clipnum=3-combined.py" \
    --checkpoint=$model_dir/"best_acc_top1_epoch_14.pth" \
    --video_dir=$video_dir \
