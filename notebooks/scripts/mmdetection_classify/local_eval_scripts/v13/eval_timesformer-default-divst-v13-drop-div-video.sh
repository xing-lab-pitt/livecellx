...
model="timesformer-default-divst-v13-drop-div-video"
...
python classify_mmdetection_mitosis_eval.py \
    ...
    --config=$model_dir/"config_train_timesformer_divst_v13-drop-div-video.py" \
    --checkpoint=$model_dir/"best_acc_top1_epoch_7.pth" \
    --video_dir=$video_dir \
