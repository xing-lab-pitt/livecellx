...
model="timesformer-default-divst-v13-drop-div-combined"
...
python classify_mmdetection_mitosis_eval.py \
    ...
    --config=$model_dir/"config_train_timesformer_divst_v13-drop-div-combined.py" \
    --checkpoint=$model_dir/"best_acc_top1_epoch_10.pth" \
    --video_dir=$video_dir \
