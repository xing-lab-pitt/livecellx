...
def parse_args():
    parser = ArgumentParser(description="Convert MMAction2 models to TorchServe `.mar` format.")
    ...
    parser.add_argument(
        "--label-file", type=str, default=None, help="A txt file which contains the action category names. "
    )
