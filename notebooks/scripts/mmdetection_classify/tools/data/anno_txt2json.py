...
def parse_args():
    parser = argparse.ArgumentParser(description="Convert txt annotation list to json")
    parser.add_argument("annofile", type=str, help="the txt annotation file to convert")
    parser.add_argument(
        "--format",
        type=str,
        default="rawframes",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help=("the output file name, use annofile.replace('.txt', '.json') " "if the arg value is None"),
    )
