...
def main(source_file, output_dir, num_jobs=24, num_attempts=5):
    ...
    if num_jobs == 1:
        ...
        status_list = Parallel(n_jobs=num_jobs)(
            delayed(download_video)(video, output_dir, num_attempts) for video in video_list
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("source_file", type=str, help="TXT file containing the video filename")
    parser.add_argument("output_dir", type=str, help="Output directory where videos will be saved")
