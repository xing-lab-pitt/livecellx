...
def download(video_identifier, output_filename, num_attempts=5, url_base="https://www.youtube.com/watch?v="):
...
def main(input, output_dir, num_jobs=24):
    ...
    if num_jobs == 1:
        ...
        status_list = Parallel(n_jobs=num_jobs)(delayed(download_wrapper)(index, output_dir) for index in youtube_ids)
...
if __name__ == "__main__":
    ...
    p.add_argument("output_dir", type=str, help="Output directory to save videos.")
