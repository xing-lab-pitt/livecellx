...
def parse_hmdb51_split(level):
    ...
    def generate_class_index_file():
        ...
        if not osp.exists(class_index_file):
            ...
            class_dict = {class_name: class_id + 1 for class_id, class_name in enumerate(class_list)}
            ...
            for class_name in class_dict:
                ...
                with open(filename_path, "r") as fin:
                    for line in fin:
                        ...
                        if video_info[1] == "1":
                            target_line = " ".join([osp.join(class_name, video_name), str(class_dict[class_name])])
