...
def parse_args():
    ...
    parser.add_argument("--bsn", action="store_true", help="download for BSN annotation or official one")
...
def main(input_csv, output_dir, anno_file, num_jobs=24, is_bsn_case=False):
    ...
    if num_jobs == 1:
        ...
        status_list = Parallel(n_jobs=num_jobs)(
            delayed(download_clip_wrapper)(index, output_dir) for index in youtube_ids
        )
