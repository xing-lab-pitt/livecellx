...
p.add_argument("--ava_root", type=str, default="../../../data/ava", help="the path to save ava dataset")
p.add_argument(
    "--avakinetics_root", type=str, default="../../../data/ava_kinetics", help="the path to save ava-kinetics dataset"
)
args = p.parse_args()
