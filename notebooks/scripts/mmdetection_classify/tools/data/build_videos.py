...
def parse_args():
    ...
    parser.add_argument("--fps", type=int, default=30, help="fps of videos to be synthesized")
    parser.add_argument("--level", type=int, choices=[1, 2], default=2, help="directory level of data")
    parser.add_argument("--num-worker", type=int, default=8, help="number of workers to build videos")
    parser.add_argument("--in-format", type=str, default="jpg", choices=["jpg", "png"], help="input format")
    parser.add_argument("--start-idx", type=int, default=0, help="starting index of rawframes")
    parser.add_argument("--filename-tmpl", type=str, default="img_%05d", help="filename template of rawframes")
    parser.add_argument("--vcodec", type=str, default="mpeg4", help="coding method of videos")
    parser.add_argument("--ext", type=str, default="mp4", choices=["mp4", "avi"], help="video file extensions")
...
if __name__ == "__main__":
    ...
    done_fullpath_list = glob.glob(args.src_dir + "/*" * args.level + "." + args.ext)
    ...
    if args.resume:
        ...
        print("Resuming. number of videos to be synthesized: ", len(fullpath_list))
    ...
    pool.map(encode_video, zip(fullpath_list, frame_dir_list, range(len(frame_dir_list))))
