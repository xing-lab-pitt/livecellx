...
def get_morphology_PCA(trajectory_collection, contour_num_points, trajectory_threshold = 1):
    ...
    pca_individual_list = [pca.transform(final_contour.reshape((int(len(final_contour)/(2*contour_num_points)), 2*contour_num_points))) for final_contour in flat_contour_entire_dataset]
