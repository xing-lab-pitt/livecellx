...
def get_sct_skimage_features(
    traj: SingleCellTrajectory, fl_dataset: LiveCellImageDataset, label_free_dataset: LiveCellImageDataset, Fluo=True
):
...
def get_sctc_skimage_features_pca(
    ...
    for track_id_num in traj_collection.get_track_ids():
        ...
        if len(traj) > traj_len_threshold:
            ...
            sct_skimage_features = get_sct_skimage_features(traj, fl_dataset, label_free_dataset, True)
