...
# model 76 aug
model=real-02
$PYTHON ../livecell_tracker/model_zoo/segmentation/train_csn.py --train_dir="./notebook_results/a549_ccp_vim/train_real_td_data" --test_dir="./notebook_results/a549_ccp_vim/train_real_td_data"  --source=all --model_version=version_$model --epochs=10000 --kernel_size=1 --batch_size=2 --degrees=30 --translation=0.3 --aug_scale="0.5,2" --input_type=raw_aug_duplicate --apply_gt_seg_edt --loss=MSE > train_out_td_model"$model"_resume.out