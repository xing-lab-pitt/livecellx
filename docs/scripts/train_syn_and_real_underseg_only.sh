...
# model 75 aug
model=601
nohup python ../livecell_tracker/model_zoo/segmentation/train_csn.py --train_dir="./notebook_results/a549_ccp_vim/train_data_v6" --test_dir="./notebook_results/a549_ccp_vim/test_data_v6"  --source=underseg-all --model_version=version_$model --epochs=50 --kernel_size=1 --batch_size=2 --batch_size=2 --degrees=30 --translation=0.3 --aug_scale="0.5,2" --input_type=raw_aug_duplicate --loss=BCE \
        --model_ckpt="/home/ken67/LiveCellTracker-dev/notebooks/lightning_logs/version_601/checkpoints/epoch=33-step=336838.ckpt" > train_out_v6_model"$model"_resume.out 2>&1 &
